...
def parse_arg():
    parser = argparse.ArgumentParser(
        description="Trains an agent in a the CarRacing-v2 environment with proximal policy optimization")
    ...
    # Training vars
    parser.add_argument("--model_name", type=str, default='CarRacing-v2')
